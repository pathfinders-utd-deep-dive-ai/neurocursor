...
- Chetan will start
- Frontend looks (Shreehan)
- Frontend logic (Hamid)
- The clicky part is done, the sendy part is what's not done yet
- Backend logic (Hamid)
...
Add velocity (it includes direction)
